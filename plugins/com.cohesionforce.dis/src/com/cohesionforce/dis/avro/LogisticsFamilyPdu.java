...
public class LogisticsFamilyPdu extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public LogisticsFamilyPdu(com.cohesionforce.dis.avro.Time_t reception_timestamp, com.cohesionforce.dis.avro.Time_t source_timestamp, java.lang.Integer protocolVersion, java.lang.Integer exerciseID, java.lang.Integer pduType, java.lang.Integer protocolFamily, java.lang.Long timestamp, java.lang.Integer pduLength, java.lang.Integer padding) {
  ...
  /** Creates a new LogisticsFamilyPdu RecordBuilder */
  public static com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder newBuilder() {
    return new com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder();
  }
  
  /** Creates a new LogisticsFamilyPdu RecordBuilder by copying an existing Builder */
  public static com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder newBuilder(com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder other) {
    return new com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder(other);
  }
  
  /** Creates a new LogisticsFamilyPdu RecordBuilder by copying an existing LogisticsFamilyPdu instance */
  public static com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder newBuilder(com.cohesionforce.dis.avro.LogisticsFamilyPdu other) {
    return new com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder(other);
  }
  
  /**
   * RecordBuilder for LogisticsFamilyPdu instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LogisticsFamilyPdu>
    implements org.apache.avro.data.RecordBuilder<LogisticsFamilyPdu> {
    ...
    private Builder() {
      super(com.cohesionforce.dis.avro.LogisticsFamilyPdu.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing LogisticsFamilyPdu instance */
    private Builder(com.cohesionforce.dis.avro.LogisticsFamilyPdu other) {
            super(com.cohesionforce.dis.avro.LogisticsFamilyPdu.SCHEMA$);
      if (isValidValue(fields()[0], other.reception_timestamp)) {
        this.reception_timestamp = data().deepCopy(fields()[0].schema(), other.reception_timestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'reception_timestamp' field */
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder setReceptionTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder clearReceptionTimestamp() {
    ...
    /** Sets the value of the 'source_timestamp' field */
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder setSourceTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder clearSourceTimestamp() {
    ...
    /** Sets the value of the 'protocolVersion' field */
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder setProtocolVersion(int value) {
    ...
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder clearProtocolVersion() {
    ...
    /** Sets the value of the 'exerciseID' field */
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder setExerciseID(int value) {
    ...
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder clearExerciseID() {
    ...
    /** Sets the value of the 'pduType' field */
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder setPduType(int value) {
    ...
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder clearPduType() {
    ...
    /** Sets the value of the 'protocolFamily' field */
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder setProtocolFamily(int value) {
    ...
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder clearProtocolFamily() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder setTimestamp(long value) {
    ...
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'pduLength' field */
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder setPduLength(int value) {
    ...
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder clearPduLength() {
    ...
    /** Sets the value of the 'padding' field */
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder setPadding(int value) {
    ...
    public com.cohesionforce.dis.avro.LogisticsFamilyPdu.Builder clearPadding() {
      fieldSetFlags()[8] = false;
      return this;
    }

    @Override
    public LogisticsFamilyPdu build() {
      try {
        LogisticsFamilyPdu record = new LogisticsFamilyPdu();
