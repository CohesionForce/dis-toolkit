...
public class StopFreezeReliablePdu extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public int reason;
  @Deprecated public int frozenBehavior;
  @Deprecated public int requiredReliablityService;
   ...
   */
  public StopFreezeReliablePdu(com.cohesionforce.dis.avro.Time_t reception_timestamp, com.cohesionforce.dis.avro.Time_t source_timestamp, java.lang.Integer protocolVersion, java.lang.Integer exerciseID, java.lang.Integer pduType, java.lang.Integer protocolFamily, java.lang.Long timestamp, java.lang.Integer pduLength, java.lang.Integer padding, com.cohesionforce.dis.avro.EntityID originatingEntityID, com.cohesionforce.dis.avro.EntityID receivingEntityID, com.cohesionforce.dis.avro.ClockTime realWorldTime, java.lang.Integer reason, java.lang.Integer frozenBehavior, java.lang.Integer requiredReliablityService, java.lang.Integer pad1, java.lang.Long requestID) {
    ...
    this.requiredReliablityService = requiredReliablityService;
    this.pad1 = pad1;
  ...
  public java.lang.Object get(int field$) {
    ...
    case 13: return frozenBehavior;
    case 14: return requiredReliablityService;
    case 15: return pad1;
    case 16: return requestID;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 12: reason = (java.lang.Integer)value$; break;
    case 13: frozenBehavior = (java.lang.Integer)value$; break;
    case 14: requiredReliablityService = (java.lang.Integer)value$; break;
    case 15: pad1 = (java.lang.Integer)value$; break;
    case 16: requestID = (java.lang.Long)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /**
   * Gets the value of the 'frozenBehavior' field.
   */
  public java.lang.Integer getFrozenBehavior() {
    return frozenBehavior;
  }

  /**
   * Sets the value of the 'frozenBehavior' field.
   * @param value the value to set.
   */
  public void setFrozenBehavior(java.lang.Integer value) {
    this.frozenBehavior = value;
  }

  /**
   * Gets the value of the 'requiredReliablityService' field.
   */
  public java.lang.Integer getRequiredReliablityService() {
    return requiredReliablityService;
  }

  /**
   * Sets the value of the 'requiredReliablityService' field.
   * @param value the value to set.
   */
  public void setRequiredReliablityService(java.lang.Integer value) {
  ...
  /** Creates a new StopFreezeReliablePdu RecordBuilder */
  public static com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder newBuilder() {
    return new com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder();
  }
  
  /** Creates a new StopFreezeReliablePdu RecordBuilder by copying an existing Builder */
  public static com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder newBuilder(com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder other) {
    return new com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder(other);
  }
  
  /** Creates a new StopFreezeReliablePdu RecordBuilder by copying an existing StopFreezeReliablePdu instance */
  public static com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder newBuilder(com.cohesionforce.dis.avro.StopFreezeReliablePdu other) {
    return new com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder(other);
  }
  
  /**
   * RecordBuilder for StopFreezeReliablePdu instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StopFreezeReliablePdu>
    implements org.apache.avro.data.RecordBuilder<StopFreezeReliablePdu> {
    ...
    private int reason;
    private int frozenBehavior;
    private int requiredReliablityService;
    private int pad1;
    private long requestID;

    /** Creates a new Builder */
    private Builder() {
      super(com.cohesionforce.dis.avro.StopFreezeReliablePdu.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[13], other.frozenBehavior)) {
        this.frozenBehavior = data().deepCopy(fields()[13].schema(), other.frozenBehavior);
        fieldSetFlags()[13] = true;
      }
      if (isValidValue(fields()[14], other.requiredReliablityService)) {
        this.requiredReliablityService = data().deepCopy(fields()[14].schema(), other.requiredReliablityService);
        fieldSetFlags()[14] = true;
      }
      if (isValidValue(fields()[15], other.pad1)) {
        this.pad1 = data().deepCopy(fields()[15].schema(), other.pad1);
        fieldSetFlags()[15] = true;
      }
      if (isValidValue(fields()[16], other.requestID)) {
        this.requestID = data().deepCopy(fields()[16].schema(), other.requestID);
        fieldSetFlags()[16] = true;
      }
    }
    
    /** Creates a Builder by copying an existing StopFreezeReliablePdu instance */
    private Builder(com.cohesionforce.dis.avro.StopFreezeReliablePdu other) {
            super(com.cohesionforce.dis.avro.StopFreezeReliablePdu.SCHEMA$);
      if (isValidValue(fields()[0], other.reception_timestamp)) {
        this.reception_timestamp = data().deepCopy(fields()[0].schema(), other.reception_timestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'reception_timestamp' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setReceptionTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearReceptionTimestamp() {
    ...
    /** Sets the value of the 'source_timestamp' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setSourceTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearSourceTimestamp() {
    ...
    /** Sets the value of the 'protocolVersion' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setProtocolVersion(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearProtocolVersion() {
    ...
    /** Sets the value of the 'exerciseID' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setExerciseID(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearExerciseID() {
    ...
    /** Sets the value of the 'pduType' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setPduType(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearPduType() {
    ...
    /** Sets the value of the 'protocolFamily' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setProtocolFamily(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearProtocolFamily() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setTimestamp(long value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'pduLength' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setPduLength(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearPduLength() {
    ...
    /** Sets the value of the 'padding' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setPadding(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearPadding() {
    ...
    /** Sets the value of the 'originatingEntityID' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setOriginatingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearOriginatingEntityID() {
    ...
    /** Sets the value of the 'receivingEntityID' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setReceivingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearReceivingEntityID() {
    ...
    /** Sets the value of the 'realWorldTime' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setRealWorldTime(com.cohesionforce.dis.avro.ClockTime value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearRealWorldTime() {
      realWorldTime = null;
    ...
    /** Sets the value of the 'reason' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setReason(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearReason() {
    ...
    /** Sets the value of the 'frozenBehavior' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setFrozenBehavior(int value) {
    ...
    /** Checks whether the 'frozenBehavior' field has been set */
    public boolean hasFrozenBehavior() {
      return fieldSetFlags()[13];
    }
    
    /** Clears the value of the 'frozenBehavior' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearFrozenBehavior() {
    ...
    /** Sets the value of the 'requiredReliablityService' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setRequiredReliablityService(int value) {
    ...
    /** Checks whether the 'requiredReliablityService' field has been set */
    public boolean hasRequiredReliablityService() {
      return fieldSetFlags()[14];
    }
    
    /** Clears the value of the 'requiredReliablityService' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearRequiredReliablityService() {
    ...
    /** Sets the value of the 'pad1' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setPad1(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearPad1() {
    ...
    /** Sets the value of the 'requestID' field */
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder setRequestID(long value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezeReliablePdu.Builder clearRequestID() {
      fieldSetFlags()[16] = false;
      return this;
    }

    @Override
    public StopFreezeReliablePdu build() {
      try {
        StopFreezeReliablePdu record = new StopFreezeReliablePdu();
        ...
        record.reason = fieldSetFlags()[12] ? this.reason : (java.lang.Integer) defaultValue(fields()[12]);
        record.frozenBehavior = fieldSetFlags()[13] ? this.frozenBehavior : (java.lang.Integer) defaultValue(fields()[13]);
        record.requiredReliablityService = fieldSetFlags()[14] ? this.requiredReliablityService : (java.lang.Integer) defaultValue(fields()[14]);
        record.pad1 = fieldSetFlags()[15] ? this.pad1 : (java.lang.Integer) defaultValue(fields()[15]);
        record.requestID = fieldSetFlags()[16] ? this.requestID : (java.lang.Long) defaultValue(fields()[16]);
        return record;
      } catch (Exception e) {
