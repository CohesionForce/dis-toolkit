...
public class ActionResponsePdu extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public long requestStatus;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 12: requestStatus = (java.lang.Long)value$; break;
  ...
  /**
   * Gets the value of the 'requestStatus' field.
   */
  ...
  /**
   * Sets the value of the 'requestStatus' field.
   * @param value the value to set.
   */
  public void setRequestStatus(java.lang.Long value) {
  ...
  /** Creates a new ActionResponsePdu RecordBuilder */
  public static com.cohesionforce.dis.avro.ActionResponsePdu.Builder newBuilder() {
    return new com.cohesionforce.dis.avro.ActionResponsePdu.Builder();
  }
  
  /** Creates a new ActionResponsePdu RecordBuilder by copying an existing Builder */
  public static com.cohesionforce.dis.avro.ActionResponsePdu.Builder newBuilder(com.cohesionforce.dis.avro.ActionResponsePdu.Builder other) {
    return new com.cohesionforce.dis.avro.ActionResponsePdu.Builder(other);
  }
  
  /** Creates a new ActionResponsePdu RecordBuilder by copying an existing ActionResponsePdu instance */
  public static com.cohesionforce.dis.avro.ActionResponsePdu.Builder newBuilder(com.cohesionforce.dis.avro.ActionResponsePdu other) {
    return new com.cohesionforce.dis.avro.ActionResponsePdu.Builder(other);
  }
  
  /**
   * RecordBuilder for ActionResponsePdu instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ActionResponsePdu>
    implements org.apache.avro.data.RecordBuilder<ActionResponsePdu> {
    ...
    private Builder() {
      super(com.cohesionforce.dis.avro.ActionResponsePdu.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cohesionforce.dis.avro.ActionResponsePdu.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[12], other.requestStatus)) {
        this.requestStatus = data().deepCopy(fields()[12].schema(), other.requestStatus);
    ...
    /** Creates a Builder by copying an existing ActionResponsePdu instance */
    private Builder(com.cohesionforce.dis.avro.ActionResponsePdu other) {
            super(com.cohesionforce.dis.avro.ActionResponsePdu.SCHEMA$);
      if (isValidValue(fields()[0], other.reception_timestamp)) {
        this.reception_timestamp = data().deepCopy(fields()[0].schema(), other.reception_timestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'reception_timestamp' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setReceptionTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearReceptionTimestamp() {
    ...
    /** Sets the value of the 'source_timestamp' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setSourceTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearSourceTimestamp() {
    ...
    /** Sets the value of the 'protocolVersion' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setProtocolVersion(int value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearProtocolVersion() {
    ...
    /** Sets the value of the 'exerciseID' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setExerciseID(int value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearExerciseID() {
    ...
    /** Sets the value of the 'pduType' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setPduType(int value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearPduType() {
    ...
    /** Sets the value of the 'protocolFamily' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setProtocolFamily(int value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearProtocolFamily() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setTimestamp(long value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'pduLength' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setPduLength(int value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearPduLength() {
    ...
    /** Sets the value of the 'padding' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setPadding(int value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearPadding() {
    ...
    /** Sets the value of the 'originatingEntityID' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setOriginatingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearOriginatingEntityID() {
    ...
    /** Sets the value of the 'receivingEntityID' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setReceivingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearReceivingEntityID() {
    ...
    /** Sets the value of the 'requestID' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setRequestID(long value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearRequestID() {
    ...
    /** Sets the value of the 'requestStatus' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setRequestStatus(long value) {
    ...
    /** Checks whether the 'requestStatus' field has been set */
    public boolean hasRequestStatus() {
      return fieldSetFlags()[12];
    }
    
    /** Clears the value of the 'requestStatus' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearRequestStatus() {
    ...
    /** Sets the value of the 'numberOfFixedDatums' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setNumberOfFixedDatums(long value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearNumberOfFixedDatums() {
    ...
    /** Sets the value of the 'numberOfVariableDatums' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setNumberOfVariableDatums(long value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearNumberOfVariableDatums() {
    ...
    /** Sets the value of the 'fixedDatums' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setFixedDatums(java.util.List<com.cohesionforce.dis.avro.FixedDatum> value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearFixedDatums() {
      fixedDatums = null;
    ...
    /** Sets the value of the 'variableDatums' field */
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder setVariableDatums(java.util.List<com.cohesionforce.dis.avro.VariableDatum> value) {
    ...
    public com.cohesionforce.dis.avro.ActionResponsePdu.Builder clearVariableDatums() {
      variableDatums = null;
    ...
    @Override
    public ActionResponsePdu build() {
      try {
        ActionResponsePdu record = new ActionResponsePdu();
        ...
        record.requestStatus = fieldSetFlags()[12] ? this.requestStatus : (java.lang.Long) defaultValue(fields()[12]);
