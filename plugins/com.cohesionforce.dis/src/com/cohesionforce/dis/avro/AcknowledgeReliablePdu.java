...
public class AcknowledgeReliablePdu extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public int acknowledgeFlag;
  @Deprecated public int responseFlag;
   ...
   */
  public AcknowledgeReliablePdu(com.cohesionforce.dis.avro.Time_t reception_timestamp, com.cohesionforce.dis.avro.Time_t source_timestamp, java.lang.Integer protocolVersion, java.lang.Integer exerciseID, java.lang.Integer pduType, java.lang.Integer protocolFamily, java.lang.Long timestamp, java.lang.Integer pduLength, java.lang.Integer padding, com.cohesionforce.dis.avro.EntityID originatingEntityID, com.cohesionforce.dis.avro.EntityID receivingEntityID, java.lang.Integer acknowledgeFlag, java.lang.Integer responseFlag, java.lang.Long requestID) {
  ...
  public java.lang.Object get(int field$) {
    ...
    case 11: return acknowledgeFlag;
    case 12: return responseFlag;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 11: acknowledgeFlag = (java.lang.Integer)value$; break;
    case 12: responseFlag = (java.lang.Integer)value$; break;
  ...
  /**
   * Gets the value of the 'acknowledgeFlag' field.
   */
  public java.lang.Integer getAcknowledgeFlag() {
    return acknowledgeFlag;
  }

  /**
   * Sets the value of the 'acknowledgeFlag' field.
   * @param value the value to set.
   */
  public void setAcknowledgeFlag(java.lang.Integer value) {
    this.acknowledgeFlag = value;
  }

  /**
   * Gets the value of the 'responseFlag' field.
   */
  public java.lang.Integer getResponseFlag() {
    return responseFlag;
  }

  /**
   * Sets the value of the 'responseFlag' field.
   * @param value the value to set.
   */
  public void setResponseFlag(java.lang.Integer value) {
  ...
  /** Creates a new AcknowledgeReliablePdu RecordBuilder */
  public static com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder newBuilder() {
    return new com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder();
  }
  
  /** Creates a new AcknowledgeReliablePdu RecordBuilder by copying an existing Builder */
  public static com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder newBuilder(com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder other) {
    return new com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder(other);
  }
  
  /** Creates a new AcknowledgeReliablePdu RecordBuilder by copying an existing AcknowledgeReliablePdu instance */
  public static com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder newBuilder(com.cohesionforce.dis.avro.AcknowledgeReliablePdu other) {
    return new com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder(other);
  }
  
  /**
   * RecordBuilder for AcknowledgeReliablePdu instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AcknowledgeReliablePdu>
    implements org.apache.avro.data.RecordBuilder<AcknowledgeReliablePdu> {
    ...
    private Builder() {
      super(com.cohesionforce.dis.avro.AcknowledgeReliablePdu.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[11], other.acknowledgeFlag)) {
        this.acknowledgeFlag = data().deepCopy(fields()[11].schema(), other.acknowledgeFlag);
        fieldSetFlags()[11] = true;
      }
      if (isValidValue(fields()[12], other.responseFlag)) {
        this.responseFlag = data().deepCopy(fields()[12].schema(), other.responseFlag);
    ...
    /** Creates a Builder by copying an existing AcknowledgeReliablePdu instance */
    private Builder(com.cohesionforce.dis.avro.AcknowledgeReliablePdu other) {
            super(com.cohesionforce.dis.avro.AcknowledgeReliablePdu.SCHEMA$);
      if (isValidValue(fields()[0], other.reception_timestamp)) {
        this.reception_timestamp = data().deepCopy(fields()[0].schema(), other.reception_timestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'reception_timestamp' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setReceptionTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearReceptionTimestamp() {
    ...
    /** Sets the value of the 'source_timestamp' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setSourceTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearSourceTimestamp() {
    ...
    /** Sets the value of the 'protocolVersion' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setProtocolVersion(int value) {
    ...
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearProtocolVersion() {
    ...
    /** Sets the value of the 'exerciseID' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setExerciseID(int value) {
    ...
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearExerciseID() {
    ...
    /** Sets the value of the 'pduType' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setPduType(int value) {
    ...
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearPduType() {
    ...
    /** Sets the value of the 'protocolFamily' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setProtocolFamily(int value) {
    ...
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearProtocolFamily() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setTimestamp(long value) {
    ...
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'pduLength' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setPduLength(int value) {
    ...
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearPduLength() {
    ...
    /** Sets the value of the 'padding' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setPadding(int value) {
    ...
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearPadding() {
    ...
    /** Sets the value of the 'originatingEntityID' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setOriginatingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearOriginatingEntityID() {
    ...
    /** Sets the value of the 'receivingEntityID' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setReceivingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearReceivingEntityID() {
    ...
    /** Sets the value of the 'acknowledgeFlag' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setAcknowledgeFlag(int value) {
    ...
    /** Checks whether the 'acknowledgeFlag' field has been set */
    public boolean hasAcknowledgeFlag() {
      return fieldSetFlags()[11];
    }
    
    /** Clears the value of the 'acknowledgeFlag' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearAcknowledgeFlag() {
    ...
    /** Sets the value of the 'responseFlag' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setResponseFlag(int value) {
    ...
    /** Checks whether the 'responseFlag' field has been set */
    public boolean hasResponseFlag() {
      return fieldSetFlags()[12];
    }
    
    /** Clears the value of the 'responseFlag' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearResponseFlag() {
    ...
    /** Sets the value of the 'requestID' field */
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder setRequestID(long value) {
    ...
    public com.cohesionforce.dis.avro.AcknowledgeReliablePdu.Builder clearRequestID() {
      fieldSetFlags()[13] = false;
      return this;
    }

    @Override
    public AcknowledgeReliablePdu build() {
      try {
        AcknowledgeReliablePdu record = new AcknowledgeReliablePdu();
        ...
        record.acknowledgeFlag = fieldSetFlags()[11] ? this.acknowledgeFlag : (java.lang.Integer) defaultValue(fields()[11]);
        record.responseFlag = fieldSetFlags()[12] ? this.responseFlag : (java.lang.Integer) defaultValue(fields()[12]);
