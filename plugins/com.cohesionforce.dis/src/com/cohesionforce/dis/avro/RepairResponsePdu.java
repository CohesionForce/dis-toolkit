...
public class RepairResponsePdu extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public int repairResult;
   ...
   */
  public RepairResponsePdu(com.cohesionforce.dis.avro.Time_t reception_timestamp, com.cohesionforce.dis.avro.Time_t source_timestamp, java.lang.Integer protocolVersion, java.lang.Integer exerciseID, java.lang.Integer pduType, java.lang.Integer protocolFamily, java.lang.Long timestamp, java.lang.Integer pduLength, java.lang.Integer padding, com.cohesionforce.dis.avro.EntityID receivingEntityID, com.cohesionforce.dis.avro.EntityID repairingEntityID, java.lang.Integer repairResult, java.lang.Integer padding1, java.lang.Integer padding2) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 11: repairResult = (java.lang.Integer)value$; break;
  ...
  /**
   * Gets the value of the 'repairResult' field.
   */
  ...
  /**
   * Sets the value of the 'repairResult' field.
   * @param value the value to set.
   */
  public void setRepairResult(java.lang.Integer value) {
  ...
  /** Creates a new RepairResponsePdu RecordBuilder */
  public static com.cohesionforce.dis.avro.RepairResponsePdu.Builder newBuilder() {
    return new com.cohesionforce.dis.avro.RepairResponsePdu.Builder();
  }
  
  /** Creates a new RepairResponsePdu RecordBuilder by copying an existing Builder */
  public static com.cohesionforce.dis.avro.RepairResponsePdu.Builder newBuilder(com.cohesionforce.dis.avro.RepairResponsePdu.Builder other) {
    return new com.cohesionforce.dis.avro.RepairResponsePdu.Builder(other);
  }
  
  /** Creates a new RepairResponsePdu RecordBuilder by copying an existing RepairResponsePdu instance */
  public static com.cohesionforce.dis.avro.RepairResponsePdu.Builder newBuilder(com.cohesionforce.dis.avro.RepairResponsePdu other) {
    return new com.cohesionforce.dis.avro.RepairResponsePdu.Builder(other);
  }
  
  /**
   * RecordBuilder for RepairResponsePdu instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RepairResponsePdu>
    implements org.apache.avro.data.RecordBuilder<RepairResponsePdu> {
    ...
    private Builder() {
      super(com.cohesionforce.dis.avro.RepairResponsePdu.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cohesionforce.dis.avro.RepairResponsePdu.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[11], other.repairResult)) {
        this.repairResult = data().deepCopy(fields()[11].schema(), other.repairResult);
    ...
    /** Creates a Builder by copying an existing RepairResponsePdu instance */
    private Builder(com.cohesionforce.dis.avro.RepairResponsePdu other) {
            super(com.cohesionforce.dis.avro.RepairResponsePdu.SCHEMA$);
      if (isValidValue(fields()[0], other.reception_timestamp)) {
        this.reception_timestamp = data().deepCopy(fields()[0].schema(), other.reception_timestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'reception_timestamp' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setReceptionTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearReceptionTimestamp() {
    ...
    /** Sets the value of the 'source_timestamp' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setSourceTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearSourceTimestamp() {
    ...
    /** Sets the value of the 'protocolVersion' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setProtocolVersion(int value) {
    ...
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearProtocolVersion() {
    ...
    /** Sets the value of the 'exerciseID' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setExerciseID(int value) {
    ...
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearExerciseID() {
    ...
    /** Sets the value of the 'pduType' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setPduType(int value) {
    ...
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearPduType() {
    ...
    /** Sets the value of the 'protocolFamily' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setProtocolFamily(int value) {
    ...
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearProtocolFamily() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setTimestamp(long value) {
    ...
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'pduLength' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setPduLength(int value) {
    ...
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearPduLength() {
    ...
    /** Sets the value of the 'padding' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setPadding(int value) {
    ...
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearPadding() {
    ...
    /** Sets the value of the 'receivingEntityID' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setReceivingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearReceivingEntityID() {
    ...
    /** Sets the value of the 'repairingEntityID' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setRepairingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearRepairingEntityID() {
    ...
    /** Sets the value of the 'repairResult' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setRepairResult(int value) {
    ...
    /** Checks whether the 'repairResult' field has been set */
    public boolean hasRepairResult() {
      return fieldSetFlags()[11];
    }
    
    /** Clears the value of the 'repairResult' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearRepairResult() {
    ...
    /** Sets the value of the 'padding1' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setPadding1(int value) {
    ...
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearPadding1() {
    ...
    /** Sets the value of the 'padding2' field */
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder setPadding2(int value) {
    ...
    public com.cohesionforce.dis.avro.RepairResponsePdu.Builder clearPadding2() {
      fieldSetFlags()[13] = false;
      return this;
    }

    @Override
    public RepairResponsePdu build() {
      try {
        RepairResponsePdu record = new RepairResponsePdu();
        ...
        record.repairResult = fieldSetFlags()[11] ? this.repairResult : (java.lang.Integer) defaultValue(fields()[11]);
