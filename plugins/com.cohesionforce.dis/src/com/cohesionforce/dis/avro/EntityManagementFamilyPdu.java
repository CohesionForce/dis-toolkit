...
public class EntityManagementFamilyPdu extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EntityManagementFamilyPdu\",\"namespace\":\"com.cohesionforce.dis.avro\",\"fields\":[{\"name\":\"reception_timestamp\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"Time_t\",\"fields\":[{\"name\":\"sec\",\"type\":\"int\"},{\"name\":\"nanosec\",\"type\":\"int\"}]}]},{\"name\":\"source_timestamp\",\"type\":[\"null\",\"Time_t\"]},{\"name\":\"protocolVersion\",\"type\":\"int\"},{\"name\":\"exerciseID\",\"type\":\"int\"},{\"name\":\"pduType\",\"type\":\"int\"},{\"name\":\"protocolFamily\",\"type\":\"int\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"pduLength\",\"type\":\"int\"},{\"name\":\"padding\",\"type\":\"int\"}]}");
   ...
   */
  public EntityManagementFamilyPdu(com.cohesionforce.dis.avro.Time_t reception_timestamp, com.cohesionforce.dis.avro.Time_t source_timestamp, java.lang.Integer protocolVersion, java.lang.Integer exerciseID, java.lang.Integer pduType, java.lang.Integer protocolFamily, java.lang.Long timestamp, java.lang.Integer pduLength, java.lang.Integer padding) {
  ...
  /** Creates a new EntityManagementFamilyPdu RecordBuilder */
  public static com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder newBuilder() {
    return new com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder();
  }
  
  /** Creates a new EntityManagementFamilyPdu RecordBuilder by copying an existing Builder */
  public static com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder newBuilder(com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder other) {
    return new com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder(other);
  }
  
  /** Creates a new EntityManagementFamilyPdu RecordBuilder by copying an existing EntityManagementFamilyPdu instance */
  public static com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder newBuilder(com.cohesionforce.dis.avro.EntityManagementFamilyPdu other) {
    return new com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder(other);
  }
  
  /**
   * RecordBuilder for EntityManagementFamilyPdu instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EntityManagementFamilyPdu>
    implements org.apache.avro.data.RecordBuilder<EntityManagementFamilyPdu> {
    ...
    private Builder() {
      super(com.cohesionforce.dis.avro.EntityManagementFamilyPdu.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing EntityManagementFamilyPdu instance */
    private Builder(com.cohesionforce.dis.avro.EntityManagementFamilyPdu other) {
            super(com.cohesionforce.dis.avro.EntityManagementFamilyPdu.SCHEMA$);
      if (isValidValue(fields()[0], other.reception_timestamp)) {
        this.reception_timestamp = data().deepCopy(fields()[0].schema(), other.reception_timestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'reception_timestamp' field */
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder setReceptionTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder clearReceptionTimestamp() {
    ...
    /** Sets the value of the 'source_timestamp' field */
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder setSourceTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder clearSourceTimestamp() {
    ...
    /** Sets the value of the 'protocolVersion' field */
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder setProtocolVersion(int value) {
    ...
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder clearProtocolVersion() {
    ...
    /** Sets the value of the 'exerciseID' field */
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder setExerciseID(int value) {
    ...
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder clearExerciseID() {
    ...
    /** Sets the value of the 'pduType' field */
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder setPduType(int value) {
    ...
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder clearPduType() {
    ...
    /** Sets the value of the 'protocolFamily' field */
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder setProtocolFamily(int value) {
    ...
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder clearProtocolFamily() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder setTimestamp(long value) {
    ...
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'pduLength' field */
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder setPduLength(int value) {
    ...
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder clearPduLength() {
    ...
    /** Sets the value of the 'padding' field */
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder setPadding(int value) {
    ...
    public com.cohesionforce.dis.avro.EntityManagementFamilyPdu.Builder clearPadding() {
      fieldSetFlags()[8] = false;
      return this;
    }

    @Override
    public EntityManagementFamilyPdu build() {
      try {
        EntityManagementFamilyPdu record = new EntityManagementFamilyPdu();
