...
public class RemoveEntityPdu extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public RemoveEntityPdu(com.cohesionforce.dis.avro.Time_t reception_timestamp, com.cohesionforce.dis.avro.Time_t source_timestamp, java.lang.Integer protocolVersion, java.lang.Integer exerciseID, java.lang.Integer pduType, java.lang.Integer protocolFamily, java.lang.Long timestamp, java.lang.Integer pduLength, java.lang.Integer padding, com.cohesionforce.dis.avro.EntityID originatingEntityID, com.cohesionforce.dis.avro.EntityID receivingEntityID, java.lang.Long requestID) {
  ...
  /** Creates a new RemoveEntityPdu RecordBuilder */
  public static com.cohesionforce.dis.avro.RemoveEntityPdu.Builder newBuilder() {
    return new com.cohesionforce.dis.avro.RemoveEntityPdu.Builder();
  }
  
  /** Creates a new RemoveEntityPdu RecordBuilder by copying an existing Builder */
  public static com.cohesionforce.dis.avro.RemoveEntityPdu.Builder newBuilder(com.cohesionforce.dis.avro.RemoveEntityPdu.Builder other) {
    return new com.cohesionforce.dis.avro.RemoveEntityPdu.Builder(other);
  }
  
  /** Creates a new RemoveEntityPdu RecordBuilder by copying an existing RemoveEntityPdu instance */
  public static com.cohesionforce.dis.avro.RemoveEntityPdu.Builder newBuilder(com.cohesionforce.dis.avro.RemoveEntityPdu other) {
    return new com.cohesionforce.dis.avro.RemoveEntityPdu.Builder(other);
  }
  
  /**
   * RecordBuilder for RemoveEntityPdu instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RemoveEntityPdu>
    implements org.apache.avro.data.RecordBuilder<RemoveEntityPdu> {
    ...
    private Builder() {
      super(com.cohesionforce.dis.avro.RemoveEntityPdu.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cohesionforce.dis.avro.RemoveEntityPdu.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing RemoveEntityPdu instance */
    private Builder(com.cohesionforce.dis.avro.RemoveEntityPdu other) {
            super(com.cohesionforce.dis.avro.RemoveEntityPdu.SCHEMA$);
      if (isValidValue(fields()[0], other.reception_timestamp)) {
        this.reception_timestamp = data().deepCopy(fields()[0].schema(), other.reception_timestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'reception_timestamp' field */
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder setReceptionTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder clearReceptionTimestamp() {
    ...
    /** Sets the value of the 'source_timestamp' field */
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder setSourceTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder clearSourceTimestamp() {
    ...
    /** Sets the value of the 'protocolVersion' field */
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder setProtocolVersion(int value) {
    ...
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder clearProtocolVersion() {
    ...
    /** Sets the value of the 'exerciseID' field */
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder setExerciseID(int value) {
    ...
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder clearExerciseID() {
    ...
    /** Sets the value of the 'pduType' field */
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder setPduType(int value) {
    ...
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder clearPduType() {
    ...
    /** Sets the value of the 'protocolFamily' field */
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder setProtocolFamily(int value) {
    ...
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder clearProtocolFamily() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder setTimestamp(long value) {
    ...
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'pduLength' field */
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder setPduLength(int value) {
    ...
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder clearPduLength() {
    ...
    /** Sets the value of the 'padding' field */
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder setPadding(int value) {
    ...
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder clearPadding() {
    ...
    /** Sets the value of the 'originatingEntityID' field */
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder setOriginatingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder clearOriginatingEntityID() {
    ...
    /** Sets the value of the 'receivingEntityID' field */
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder setReceivingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder clearReceivingEntityID() {
    ...
    /** Sets the value of the 'requestID' field */
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder setRequestID(long value) {
    ...
    public com.cohesionforce.dis.avro.RemoveEntityPdu.Builder clearRequestID() {
      fieldSetFlags()[11] = false;
      return this;
    }

    @Override
    public RemoveEntityPdu build() {
      try {
        RemoveEntityPdu record = new RemoveEntityPdu();
