...
public class DistributedEmissionsFamilyPdu extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DistributedEmissionsFamilyPdu\",\"namespace\":\"com.cohesionforce.dis.avro\",\"fields\":[{\"name\":\"reception_timestamp\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"Time_t\",\"fields\":[{\"name\":\"sec\",\"type\":\"int\"},{\"name\":\"nanosec\",\"type\":\"int\"}]}]},{\"name\":\"source_timestamp\",\"type\":[\"null\",\"Time_t\"]},{\"name\":\"protocolVersion\",\"type\":\"int\"},{\"name\":\"exerciseID\",\"type\":\"int\"},{\"name\":\"pduType\",\"type\":\"int\"},{\"name\":\"protocolFamily\",\"type\":\"int\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"pduLength\",\"type\":\"int\"},{\"name\":\"padding\",\"type\":\"int\"}]}");
   ...
   */
  public DistributedEmissionsFamilyPdu(com.cohesionforce.dis.avro.Time_t reception_timestamp, com.cohesionforce.dis.avro.Time_t source_timestamp, java.lang.Integer protocolVersion, java.lang.Integer exerciseID, java.lang.Integer pduType, java.lang.Integer protocolFamily, java.lang.Long timestamp, java.lang.Integer pduLength, java.lang.Integer padding) {
  ...
  /** Creates a new DistributedEmissionsFamilyPdu RecordBuilder */
  public static com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder newBuilder() {
    return new com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder();
  }
  
  /** Creates a new DistributedEmissionsFamilyPdu RecordBuilder by copying an existing Builder */
  public static com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder newBuilder(com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder other) {
    return new com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder(other);
  }
  
  /** Creates a new DistributedEmissionsFamilyPdu RecordBuilder by copying an existing DistributedEmissionsFamilyPdu instance */
  public static com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder newBuilder(com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu other) {
    return new com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder(other);
  }
  
  /**
   * RecordBuilder for DistributedEmissionsFamilyPdu instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DistributedEmissionsFamilyPdu>
    implements org.apache.avro.data.RecordBuilder<DistributedEmissionsFamilyPdu> {
    ...
    private Builder() {
      super(com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing DistributedEmissionsFamilyPdu instance */
    private Builder(com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu other) {
            super(com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.SCHEMA$);
      if (isValidValue(fields()[0], other.reception_timestamp)) {
        this.reception_timestamp = data().deepCopy(fields()[0].schema(), other.reception_timestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'reception_timestamp' field */
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder setReceptionTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder clearReceptionTimestamp() {
    ...
    /** Sets the value of the 'source_timestamp' field */
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder setSourceTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder clearSourceTimestamp() {
    ...
    /** Sets the value of the 'protocolVersion' field */
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder setProtocolVersion(int value) {
    ...
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder clearProtocolVersion() {
    ...
    /** Sets the value of the 'exerciseID' field */
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder setExerciseID(int value) {
    ...
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder clearExerciseID() {
    ...
    /** Sets the value of the 'pduType' field */
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder setPduType(int value) {
    ...
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder clearPduType() {
    ...
    /** Sets the value of the 'protocolFamily' field */
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder setProtocolFamily(int value) {
    ...
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder clearProtocolFamily() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder setTimestamp(long value) {
    ...
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'pduLength' field */
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder setPduLength(int value) {
    ...
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder clearPduLength() {
    ...
    /** Sets the value of the 'padding' field */
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder setPadding(int value) {
    ...
    public com.cohesionforce.dis.avro.DistributedEmissionsFamilyPdu.Builder clearPadding() {
      fieldSetFlags()[8] = false;
      return this;
    }

    @Override
    public DistributedEmissionsFamilyPdu build() {
      try {
        DistributedEmissionsFamilyPdu record = new DistributedEmissionsFamilyPdu();
