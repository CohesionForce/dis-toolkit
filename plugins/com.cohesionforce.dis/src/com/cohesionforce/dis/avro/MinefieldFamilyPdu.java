...
public class MinefieldFamilyPdu extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** Creates a new MinefieldFamilyPdu RecordBuilder */
  public static com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder newBuilder() {
    return new com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder();
  }
  
  /** Creates a new MinefieldFamilyPdu RecordBuilder by copying an existing Builder */
  public static com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder newBuilder(com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder other) {
    return new com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder(other);
  }
  
  /** Creates a new MinefieldFamilyPdu RecordBuilder by copying an existing MinefieldFamilyPdu instance */
  public static com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder newBuilder(com.cohesionforce.dis.avro.MinefieldFamilyPdu other) {
    return new com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder(other);
  }
  
  /**
   * RecordBuilder for MinefieldFamilyPdu instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MinefieldFamilyPdu>
    implements org.apache.avro.data.RecordBuilder<MinefieldFamilyPdu> {
    ...
    private Builder() {
      super(com.cohesionforce.dis.avro.MinefieldFamilyPdu.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing MinefieldFamilyPdu instance */
    private Builder(com.cohesionforce.dis.avro.MinefieldFamilyPdu other) {
            super(com.cohesionforce.dis.avro.MinefieldFamilyPdu.SCHEMA$);
      if (isValidValue(fields()[0], other.reception_timestamp)) {
        this.reception_timestamp = data().deepCopy(fields()[0].schema(), other.reception_timestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'reception_timestamp' field */
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder setReceptionTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder clearReceptionTimestamp() {
    ...
    /** Sets the value of the 'source_timestamp' field */
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder setSourceTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder clearSourceTimestamp() {
    ...
    /** Sets the value of the 'protocolVersion' field */
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder setProtocolVersion(int value) {
    ...
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder clearProtocolVersion() {
    ...
    /** Sets the value of the 'exerciseID' field */
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder setExerciseID(int value) {
    ...
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder clearExerciseID() {
    ...
    /** Sets the value of the 'pduType' field */
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder setPduType(int value) {
    ...
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder clearPduType() {
    ...
    /** Sets the value of the 'protocolFamily' field */
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder setProtocolFamily(int value) {
    ...
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder clearProtocolFamily() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder setTimestamp(long value) {
    ...
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'pduLength' field */
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder setPduLength(int value) {
    ...
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder clearPduLength() {
    ...
    /** Sets the value of the 'padding' field */
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder setPadding(int value) {
    ...
    public com.cohesionforce.dis.avro.MinefieldFamilyPdu.Builder clearPadding() {
      fieldSetFlags()[8] = false;
      return this;
    }

    @Override
    public MinefieldFamilyPdu build() {
      try {
        MinefieldFamilyPdu record = new MinefieldFamilyPdu();
