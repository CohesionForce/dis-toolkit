...
public class RecordQueryReliablePdu extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RecordQueryReliablePdu\",\"namespace\":\"com.cohesionforce.dis.avro\",\"fields\":[{\"name\":\"reception_timestamp\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"Time_t\",\"fields\":[{\"name\":\"sec\",\"type\":\"int\"},{\"name\":\"nanosec\",\"type\":\"int\"}]}]},{\"name\":\"source_timestamp\",\"type\":[\"null\",\"Time_t\"]},{\"name\":\"protocolVersion\",\"type\":\"int\"},{\"name\":\"exerciseID\",\"type\":\"int\"},{\"name\":\"pduType\",\"type\":\"int\"},{\"name\":\"protocolFamily\",\"type\":\"int\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"pduLength\",\"type\":\"int\"},{\"name\":\"padding\",\"type\":\"int\"},{\"name\":\"originatingEntityID\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"EntityID\",\"fields\":[{\"name\":\"site\",\"type\":\"int\"},{\"name\":\"application\",\"type\":\"int\"},{\"name\":\"entity\",\"type\":\"int\"}]}]},{\"name\":\"receivingEntityID\",\"type\":[\"null\",\"EntityID\"]},{\"name\":\"requestID\",\"type\":\"long\"},{\"name\":\"requiredReliabilityService\",\"type\":\"int\"},{\"name\":\"pad1\",\"type\":\"int\"},{\"name\":\"pad2\",\"type\":\"int\"},{\"name\":\"eventType\",\"type\":\"int\"},{\"name\":\"time\",\"type\":\"long\"},{\"name\":\"numberOfRecordIDs\",\"type\":\"long\"},{\"name\":\"recordIDs\",\"type\":[\"null\",{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"FourByteChunk\",\"fields\":[{\"name\":\"otherParameters\",\"type\":[\"null\",{\"type\":\"array\",\"items\":\"int\"}]}]}}]}]}");
  ...
  @Deprecated public long numberOfRecordIDs;
  @Deprecated public java.util.List<com.cohesionforce.dis.avro.FourByteChunk> recordIDs;
   ...
   */
  public RecordQueryReliablePdu(com.cohesionforce.dis.avro.Time_t reception_timestamp, com.cohesionforce.dis.avro.Time_t source_timestamp, java.lang.Integer protocolVersion, java.lang.Integer exerciseID, java.lang.Integer pduType, java.lang.Integer protocolFamily, java.lang.Long timestamp, java.lang.Integer pduLength, java.lang.Integer padding, com.cohesionforce.dis.avro.EntityID originatingEntityID, com.cohesionforce.dis.avro.EntityID receivingEntityID, java.lang.Long requestID, java.lang.Integer requiredReliabilityService, java.lang.Integer pad1, java.lang.Integer pad2, java.lang.Integer eventType, java.lang.Long time, java.lang.Long numberOfRecordIDs, java.util.List<com.cohesionforce.dis.avro.FourByteChunk> recordIDs) {
  ...
  public java.lang.Object get(int field$) {
    ...
    case 16: return time;
    case 17: return numberOfRecordIDs;
    case 18: return recordIDs;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 15: eventType = (java.lang.Integer)value$; break;
    case 16: time = (java.lang.Long)value$; break;
    case 17: numberOfRecordIDs = (java.lang.Long)value$; break;
    case 18: recordIDs = (java.util.List<com.cohesionforce.dis.avro.FourByteChunk>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /**
   * Gets the value of the 'numberOfRecordIDs' field.
   */
  public java.lang.Long getNumberOfRecordIDs() {
    return numberOfRecordIDs;
  }

  /**
   * Sets the value of the 'numberOfRecordIDs' field.
   * @param value the value to set.
   */
  public void setNumberOfRecordIDs(java.lang.Long value) {
    this.numberOfRecordIDs = value;
  }

  /**
   * Gets the value of the 'recordIDs' field.
   */
  public java.util.List<com.cohesionforce.dis.avro.FourByteChunk> getRecordIDs() {
    return recordIDs;
  }
   ...
   * @param value the value to set.
   */
  public void setRecordIDs(java.util.List<com.cohesionforce.dis.avro.FourByteChunk> value) {
    this.recordIDs = value;
  }

  /** Creates a new RecordQueryReliablePdu RecordBuilder */
  public static com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder newBuilder() {
    return new com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder();
  }
  
  /** Creates a new RecordQueryReliablePdu RecordBuilder by copying an existing Builder */
  public static com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder newBuilder(com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder other) {
    return new com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder(other);
  }
  
  /** Creates a new RecordQueryReliablePdu RecordBuilder by copying an existing RecordQueryReliablePdu instance */
  public static com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder newBuilder(com.cohesionforce.dis.avro.RecordQueryReliablePdu other) {
    return new com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder(other);
  }
  
  /**
   * RecordBuilder for RecordQueryReliablePdu instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RecordQueryReliablePdu>
    implements org.apache.avro.data.RecordBuilder<RecordQueryReliablePdu> {
    ...
    private long time;
    private long numberOfRecordIDs;
    private java.util.List<com.cohesionforce.dis.avro.FourByteChunk> recordIDs;

    /** Creates a new Builder */
    private Builder() {
      super(com.cohesionforce.dis.avro.RecordQueryReliablePdu.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[17], other.numberOfRecordIDs)) {
        this.numberOfRecordIDs = data().deepCopy(fields()[17].schema(), other.numberOfRecordIDs);
        fieldSetFlags()[17] = true;
      }
      if (isValidValue(fields()[18], other.recordIDs)) {
        this.recordIDs = data().deepCopy(fields()[18].schema(), other.recordIDs);
        fieldSetFlags()[18] = true;
      }
    }
    
    /** Creates a Builder by copying an existing RecordQueryReliablePdu instance */
    private Builder(com.cohesionforce.dis.avro.RecordQueryReliablePdu other) {
            super(com.cohesionforce.dis.avro.RecordQueryReliablePdu.SCHEMA$);
      if (isValidValue(fields()[0], other.reception_timestamp)) {
        this.reception_timestamp = data().deepCopy(fields()[0].schema(), other.reception_timestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'reception_timestamp' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setReceptionTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearReceptionTimestamp() {
    ...
    /** Sets the value of the 'source_timestamp' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setSourceTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearSourceTimestamp() {
    ...
    /** Sets the value of the 'protocolVersion' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setProtocolVersion(int value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearProtocolVersion() {
    ...
    /** Sets the value of the 'exerciseID' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setExerciseID(int value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearExerciseID() {
    ...
    /** Sets the value of the 'pduType' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setPduType(int value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearPduType() {
    ...
    /** Sets the value of the 'protocolFamily' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setProtocolFamily(int value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearProtocolFamily() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setTimestamp(long value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'pduLength' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setPduLength(int value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearPduLength() {
    ...
    /** Sets the value of the 'padding' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setPadding(int value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearPadding() {
    ...
    /** Sets the value of the 'originatingEntityID' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setOriginatingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearOriginatingEntityID() {
    ...
    /** Sets the value of the 'receivingEntityID' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setReceivingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearReceivingEntityID() {
    ...
    /** Sets the value of the 'requestID' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setRequestID(long value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearRequestID() {
    ...
    /** Sets the value of the 'requiredReliabilityService' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setRequiredReliabilityService(int value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearRequiredReliabilityService() {
    ...
    /** Sets the value of the 'pad1' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setPad1(int value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearPad1() {
    ...
    /** Sets the value of the 'pad2' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setPad2(int value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearPad2() {
    ...
    /** Sets the value of the 'eventType' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setEventType(int value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearEventType() {
    ...
    /** Sets the value of the 'time' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setTime(long value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearTime() {
    ...
    /** Sets the value of the 'numberOfRecordIDs' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setNumberOfRecordIDs(long value) {
    ...
    /** Checks whether the 'numberOfRecordIDs' field has been set */
    public boolean hasNumberOfRecordIDs() {
      return fieldSetFlags()[17];
    }
    
    /** Clears the value of the 'numberOfRecordIDs' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearNumberOfRecordIDs() {
    ...
    /** Sets the value of the 'recordIDs' field */
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder setRecordIDs(java.util.List<com.cohesionforce.dis.avro.FourByteChunk> value) {
    ...
    public com.cohesionforce.dis.avro.RecordQueryReliablePdu.Builder clearRecordIDs() {
      recordIDs = null;
    ...
    @Override
    public RecordQueryReliablePdu build() {
      try {
        RecordQueryReliablePdu record = new RecordQueryReliablePdu();
        ...
        record.eventType = fieldSetFlags()[15] ? this.eventType : (java.lang.Integer) defaultValue(fields()[15]);
        record.time = fieldSetFlags()[16] ? this.time : (java.lang.Long) defaultValue(fields()[16]);
        record.numberOfRecordIDs = fieldSetFlags()[17] ? this.numberOfRecordIDs : (java.lang.Long) defaultValue(fields()[17]);
        record.recordIDs = fieldSetFlags()[18] ? this.recordIDs : (java.util.List<com.cohesionforce.dis.avro.FourByteChunk>) defaultValue(fields()[18]);
        return record;
      } catch (Exception e) {
