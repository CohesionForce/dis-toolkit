...
public class SyntheticEnvironmentFamilyPdu extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SyntheticEnvironmentFamilyPdu\",\"namespace\":\"com.cohesionforce.dis.avro\",\"fields\":[{\"name\":\"reception_timestamp\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"Time_t\",\"fields\":[{\"name\":\"sec\",\"type\":\"int\"},{\"name\":\"nanosec\",\"type\":\"int\"}]}]},{\"name\":\"source_timestamp\",\"type\":[\"null\",\"Time_t\"]},{\"name\":\"protocolVersion\",\"type\":\"int\"},{\"name\":\"exerciseID\",\"type\":\"int\"},{\"name\":\"pduType\",\"type\":\"int\"},{\"name\":\"protocolFamily\",\"type\":\"int\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"pduLength\",\"type\":\"int\"},{\"name\":\"padding\",\"type\":\"int\"}]}");
  ...
  /** Creates a new SyntheticEnvironmentFamilyPdu RecordBuilder */
  public static com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder newBuilder() {
    return new com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder();
  }
  
  /** Creates a new SyntheticEnvironmentFamilyPdu RecordBuilder by copying an existing Builder */
  public static com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder newBuilder(com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder other) {
    return new com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder(other);
  }
  
  /** Creates a new SyntheticEnvironmentFamilyPdu RecordBuilder by copying an existing SyntheticEnvironmentFamilyPdu instance */
  public static com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder newBuilder(com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu other) {
    return new com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder(other);
  }
  
  /**
   * RecordBuilder for SyntheticEnvironmentFamilyPdu instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SyntheticEnvironmentFamilyPdu>
    implements org.apache.avro.data.RecordBuilder<SyntheticEnvironmentFamilyPdu> {
    ...
    private Builder() {
      super(com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing SyntheticEnvironmentFamilyPdu instance */
    private Builder(com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu other) {
            super(com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.SCHEMA$);
      if (isValidValue(fields()[0], other.reception_timestamp)) {
        this.reception_timestamp = data().deepCopy(fields()[0].schema(), other.reception_timestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'reception_timestamp' field */
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder setReceptionTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder clearReceptionTimestamp() {
    ...
    /** Sets the value of the 'source_timestamp' field */
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder setSourceTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder clearSourceTimestamp() {
    ...
    /** Sets the value of the 'protocolVersion' field */
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder setProtocolVersion(int value) {
    ...
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder clearProtocolVersion() {
    ...
    /** Sets the value of the 'exerciseID' field */
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder setExerciseID(int value) {
    ...
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder clearExerciseID() {
    ...
    /** Sets the value of the 'pduType' field */
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder setPduType(int value) {
    ...
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder clearPduType() {
    ...
    /** Sets the value of the 'protocolFamily' field */
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder setProtocolFamily(int value) {
    ...
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder clearProtocolFamily() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder setTimestamp(long value) {
    ...
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'pduLength' field */
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder setPduLength(int value) {
    ...
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder clearPduLength() {
    ...
    /** Sets the value of the 'padding' field */
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder setPadding(int value) {
    ...
    public com.cohesionforce.dis.avro.SyntheticEnvironmentFamilyPdu.Builder clearPadding() {
      fieldSetFlags()[8] = false;
      return this;
    }

    @Override
    public SyntheticEnvironmentFamilyPdu build() {
      try {
        SyntheticEnvironmentFamilyPdu record = new SyntheticEnvironmentFamilyPdu();
