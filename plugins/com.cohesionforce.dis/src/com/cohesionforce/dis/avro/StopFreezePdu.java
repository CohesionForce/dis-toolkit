...
public class StopFreezePdu extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public StopFreezePdu(com.cohesionforce.dis.avro.Time_t reception_timestamp, com.cohesionforce.dis.avro.Time_t source_timestamp, java.lang.Integer protocolVersion, java.lang.Integer exerciseID, java.lang.Integer pduType, java.lang.Integer protocolFamily, java.lang.Long timestamp, java.lang.Integer pduLength, java.lang.Integer padding, com.cohesionforce.dis.avro.EntityID originatingEntityID, com.cohesionforce.dis.avro.EntityID receivingEntityID, com.cohesionforce.dis.avro.ClockTime realWorldTime, java.lang.Integer reason, java.lang.Integer frozenBehavior, java.lang.Integer padding1, java.lang.Long requestID) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 15: requestID = (java.lang.Long)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /** Creates a new StopFreezePdu RecordBuilder */
  public static com.cohesionforce.dis.avro.StopFreezePdu.Builder newBuilder() {
    return new com.cohesionforce.dis.avro.StopFreezePdu.Builder();
  }
  
  /** Creates a new StopFreezePdu RecordBuilder by copying an existing Builder */
  public static com.cohesionforce.dis.avro.StopFreezePdu.Builder newBuilder(com.cohesionforce.dis.avro.StopFreezePdu.Builder other) {
    return new com.cohesionforce.dis.avro.StopFreezePdu.Builder(other);
  }
  
  /** Creates a new StopFreezePdu RecordBuilder by copying an existing StopFreezePdu instance */
  public static com.cohesionforce.dis.avro.StopFreezePdu.Builder newBuilder(com.cohesionforce.dis.avro.StopFreezePdu other) {
    return new com.cohesionforce.dis.avro.StopFreezePdu.Builder(other);
  }
  
  /**
   * RecordBuilder for StopFreezePdu instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StopFreezePdu>
    implements org.apache.avro.data.RecordBuilder<StopFreezePdu> {
    ...
    private Builder() {
      super(com.cohesionforce.dis.avro.StopFreezePdu.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cohesionforce.dis.avro.StopFreezePdu.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[15], other.requestID)) {
        this.requestID = data().deepCopy(fields()[15].schema(), other.requestID);
        fieldSetFlags()[15] = true;
      }
    }
    
    /** Creates a Builder by copying an existing StopFreezePdu instance */
    private Builder(com.cohesionforce.dis.avro.StopFreezePdu other) {
            super(com.cohesionforce.dis.avro.StopFreezePdu.SCHEMA$);
      if (isValidValue(fields()[0], other.reception_timestamp)) {
        this.reception_timestamp = data().deepCopy(fields()[0].schema(), other.reception_timestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'reception_timestamp' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setReceptionTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearReceptionTimestamp() {
    ...
    /** Sets the value of the 'source_timestamp' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setSourceTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearSourceTimestamp() {
    ...
    /** Sets the value of the 'protocolVersion' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setProtocolVersion(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearProtocolVersion() {
    ...
    /** Sets the value of the 'exerciseID' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setExerciseID(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearExerciseID() {
    ...
    /** Sets the value of the 'pduType' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setPduType(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearPduType() {
    ...
    /** Sets the value of the 'protocolFamily' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setProtocolFamily(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearProtocolFamily() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setTimestamp(long value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'pduLength' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setPduLength(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearPduLength() {
    ...
    /** Sets the value of the 'padding' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setPadding(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearPadding() {
    ...
    /** Sets the value of the 'originatingEntityID' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setOriginatingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearOriginatingEntityID() {
    ...
    /** Sets the value of the 'receivingEntityID' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setReceivingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearReceivingEntityID() {
    ...
    /** Sets the value of the 'realWorldTime' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setRealWorldTime(com.cohesionforce.dis.avro.ClockTime value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearRealWorldTime() {
      realWorldTime = null;
    ...
    /** Sets the value of the 'reason' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setReason(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearReason() {
    ...
    /** Sets the value of the 'frozenBehavior' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setFrozenBehavior(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearFrozenBehavior() {
    ...
    /** Sets the value of the 'padding1' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setPadding1(int value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearPadding1() {
    ...
    /** Sets the value of the 'requestID' field */
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder setRequestID(long value) {
    ...
    public com.cohesionforce.dis.avro.StopFreezePdu.Builder clearRequestID() {
      fieldSetFlags()[15] = false;
      return this;
    }

    @Override
    public StopFreezePdu build() {
      try {
        StopFreezePdu record = new StopFreezePdu();
        ...
        record.requestID = fieldSetFlags()[15] ? this.requestID : (java.lang.Long) defaultValue(fields()[15]);
        return record;
      } catch (Exception e) {
