...
public class CreateEntityPdu extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public CreateEntityPdu(com.cohesionforce.dis.avro.Time_t reception_timestamp, com.cohesionforce.dis.avro.Time_t source_timestamp, java.lang.Integer protocolVersion, java.lang.Integer exerciseID, java.lang.Integer pduType, java.lang.Integer protocolFamily, java.lang.Long timestamp, java.lang.Integer pduLength, java.lang.Integer padding, com.cohesionforce.dis.avro.EntityID originatingEntityID, com.cohesionforce.dis.avro.EntityID receivingEntityID, java.lang.Long requestID) {
  ...
  /** Creates a new CreateEntityPdu RecordBuilder */
  public static com.cohesionforce.dis.avro.CreateEntityPdu.Builder newBuilder() {
    return new com.cohesionforce.dis.avro.CreateEntityPdu.Builder();
  }
  
  /** Creates a new CreateEntityPdu RecordBuilder by copying an existing Builder */
  public static com.cohesionforce.dis.avro.CreateEntityPdu.Builder newBuilder(com.cohesionforce.dis.avro.CreateEntityPdu.Builder other) {
    return new com.cohesionforce.dis.avro.CreateEntityPdu.Builder(other);
  }
  
  /** Creates a new CreateEntityPdu RecordBuilder by copying an existing CreateEntityPdu instance */
  public static com.cohesionforce.dis.avro.CreateEntityPdu.Builder newBuilder(com.cohesionforce.dis.avro.CreateEntityPdu other) {
    return new com.cohesionforce.dis.avro.CreateEntityPdu.Builder(other);
  }
  
  /**
   * RecordBuilder for CreateEntityPdu instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CreateEntityPdu>
    implements org.apache.avro.data.RecordBuilder<CreateEntityPdu> {
    ...
    private Builder() {
      super(com.cohesionforce.dis.avro.CreateEntityPdu.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cohesionforce.dis.avro.CreateEntityPdu.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing CreateEntityPdu instance */
    private Builder(com.cohesionforce.dis.avro.CreateEntityPdu other) {
            super(com.cohesionforce.dis.avro.CreateEntityPdu.SCHEMA$);
      if (isValidValue(fields()[0], other.reception_timestamp)) {
        this.reception_timestamp = data().deepCopy(fields()[0].schema(), other.reception_timestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'reception_timestamp' field */
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder setReceptionTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder clearReceptionTimestamp() {
    ...
    /** Sets the value of the 'source_timestamp' field */
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder setSourceTimestamp(com.cohesionforce.dis.avro.Time_t value) {
    ...
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder clearSourceTimestamp() {
    ...
    /** Sets the value of the 'protocolVersion' field */
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder setProtocolVersion(int value) {
    ...
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder clearProtocolVersion() {
    ...
    /** Sets the value of the 'exerciseID' field */
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder setExerciseID(int value) {
    ...
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder clearExerciseID() {
    ...
    /** Sets the value of the 'pduType' field */
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder setPduType(int value) {
    ...
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder clearPduType() {
    ...
    /** Sets the value of the 'protocolFamily' field */
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder setProtocolFamily(int value) {
    ...
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder clearProtocolFamily() {
    ...
    /** Sets the value of the 'timestamp' field */
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder setTimestamp(long value) {
    ...
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'pduLength' field */
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder setPduLength(int value) {
    ...
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder clearPduLength() {
    ...
    /** Sets the value of the 'padding' field */
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder setPadding(int value) {
    ...
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder clearPadding() {
    ...
    /** Sets the value of the 'originatingEntityID' field */
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder setOriginatingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder clearOriginatingEntityID() {
    ...
    /** Sets the value of the 'receivingEntityID' field */
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder setReceivingEntityID(com.cohesionforce.dis.avro.EntityID value) {
    ...
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder clearReceivingEntityID() {
    ...
    /** Sets the value of the 'requestID' field */
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder setRequestID(long value) {
    ...
    public com.cohesionforce.dis.avro.CreateEntityPdu.Builder clearRequestID() {
      fieldSetFlags()[11] = false;
      return this;
    }

    @Override
    public CreateEntityPdu build() {
      try {
        CreateEntityPdu record = new CreateEntityPdu();
